...
/*-------------------------------------------------------------------------- */
/*                       Object fields as options	                         */
/* ------------------------------------------------------------------------- */
const dictionaryObjectFields = {
	host: [
		{
			name: 'Host ID',
			value: 'hostid',
...
export function getSortfieldOptions(resource: string): INodePropertyOptions[] {
	...
	switch (resource) {
		case 'event': {
			options = dictionarySortfieldOptions.event;
			break;
		}
		case 'history': {
			options = dictionarySortfieldOptions.history;
			break;
		}
		case 'host': {
			options = dictionarySortfieldOptions.host;
			break;
		}
		case 'item': {
			options = dictionarySortfieldOptions.item;
			break;
		}
		case 'problem': {
...
export function getOptions(resource: string): INodePropertyOptions[] {
	...
	switch (resource) {
		case 'event': {
			options = dictionaryObjectFields.event;
			break;
		}
		case 'history': {
			options = dictionaryObjectFields.history;
			break;
		}
		case 'host': {
			options = dictionaryObjectFields.host;
			break;
		}
		case 'item': {
			options = dictionaryObjectFields.item;
			break;
		}
		case 'problem': {
...
export const dictionarySortfieldOptions = {
	// Possible values for sorting of event:get
	event: [
		{
			name: 'Event ID',
			value: 'eventid',
...
export const selectDiscoveriesQuery = [
	...
	},
	{
		...
		default: [],
		description: 'Choose which properties to return.',
		options: dictionaryObjectFields.discoveryRule,
	},
];
...
export const selectGraphsQuery = [
	...
	},
	{
		...
		default: [],
		description: 'Choose which properties to return.',
		options: dictionaryObjectFields.graph,
	},
];
...
export const selectHttpTestsQuery = [
	...
	},
	{
		...
		default: [],
		description: 'Choose which properties to return.',
		options: dictionaryObjectFields.httpTest,
	},
];
...
export const selectInterfacesQuery = [
	...
	},
	{
		...
		default: [],
		description: 'Choose which properties to return.',
		options: dictionaryObjectFields.interface,
	},
];
...
export const selectInventoryQuery = [
	...
	},
	{
		...
		default: [],
		description: 'Choose which properties to return.',
		options: dictionaryObjectFields.inventory,
	},
];
...
export const selectTriggersQuery = [
	...
	},
	{
		...
		default: [],
		description: 'Choose which properties to return.',
		options: dictionaryObjectFields.triggers,
	},
];
